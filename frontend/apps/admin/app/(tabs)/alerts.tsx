...
export default function AlertsScreen() {
    ...
    const loadConfig = async () => {
        try {
            ...
            if (config && Object.keys(config).length > 0) {
                setOccupancyThresholdCrit(String(config.occupancy_threshold_critical || 95));
                setOccupancyThresholdWarn(String(config.occupancy_threshold_warning || 80));
    ...
    return (
        <>
            <Stack.Screen options={{ title: 'Alert Configuration', headerShown: true }} />
            <KeyboardAvoidingView
                ...
                <ScrollView contentContainerStyle={styles.scrollView}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>Configure thresholds and notification channels</Text>
                    </View>
